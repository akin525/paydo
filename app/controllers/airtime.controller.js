...
exports.airtime =  async (req, res) => {
    ...
    const bil= await bill.create({
        ...
        console.log(process.env.Airtime_Url);
        var options =
            {
            'method': 'POST',
